...
5) Улучшение моментов:
   ...
   2. Улучшить генерацию:
      ...
      2. Изменить алгоритм генерации воды: не заполнять клетки в зависимости от pond, а сделать разрастание структуры из центра
...
> Общее расширение функционала игры, дварфивизация сущностей,  
> добавление источников пищи, приказов, новых потребностей,  
> главного меню, менеджера сохранений и т. д. 
...
> Пока-что игра находится на стадии кривого, ничего не демонстрируещего, вялотекущего и откровенно дер***ого прототипа. Пользователь просто смотрит на разноцветные  
